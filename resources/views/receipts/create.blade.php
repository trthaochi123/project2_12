                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{$student->id}}" name="student_id" type="text" id="student_id"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label class="item-label" for="student_name">Tên SV</label>
                                    <input value="{{$student->student_name}}" name="student_name" type="text" id="student_name"/>
                                </div>
                                 <div class="mt-3 mb-3">
                                    <label class="item-label" for="student_dob">Ngày sinh</label>
                                    <input value="{{ $student->student_dob }}" name="student_dob" type="date" id="student_dob"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label class="item-label" for="amount_each_time">Số tiền/lần đóng</label>
                                    <input  value="{{ $student->amount_each_time }}" name="amount_each_time" type="text" id="amount_each_time"/>
                                </div>
                                @endforeach
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $student->amount_each_time }}"  name="amount_of_money" type="text" id="amount_of_money"/>
                                </div>
                                <div class="mt-3 mb-3">
