            ...
            <ul class="category">
                <li>
                    <a href="{{ route('receipts.index') }}">
                        <span><i class="fas fa-receipt"></i> Receipts List</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('receipts.students') }}">
                        <span><i class="fas fa-user-graduate"></i> Students List</span>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <span><i class="fas fa-receipt"></i> Debt</span>
                    </a>
                </li>
            </ul>
        </div>
        <div class="content">
            <h3 class="table-name2">Công nợ</h3>
                            ...
                            <tr>
                                ...
                                <td class="btn-issue-receipts">
                                    <div class="issue-receipts">
                                        <a href="{{ route('receipts.create',$receipt->id) }}">
