                        ...
                        @foreach($academics as $academic)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $academic->academic_start_year }}" name="academic_start_year" type="date" id="academic_start_year" class="form-control form-control-sm"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="academic_end_year">Academic end year</label>
                                    <input value="{{ $academic->academic_end_year }}" name="academic_end_year" type="date" id="academic_end_year" class="form-control form-control-sm"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="academic_name">Academic name</label>
                                    <input value="{{ $academic->academic_name }}" name="academic_name" type="text" id="academic_name" class="form-control form-control-sm"/>
                                </div>
                                <div>
