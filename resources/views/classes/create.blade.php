...
<div class="root">
    ...
    <div class="main">
        ...
        <div class="content">
            <h3 class="table-name2">Create A New Class</h3>
            <div class="add-form">
                <form method="post" action="{{ route('study_classes.store') }}">
                    <div class="form-heading">Enter Information Fields</div>
                    @csrf
                    <div class="inputs-list">
                        <div class="mt-3 mb-3">
                            <label for="class_name">Class name</label>
                            <input name="class_name" type="text" id="class_name" class="form-control form-control-sm"/>
                        </div>
                        <div class="mt-3 mb-3">
