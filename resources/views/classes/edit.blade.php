...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Edit A Class</h3>
                <div class="add-form">
                        ...
                        @foreach($classes as $study_class)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value={{ $study_class->class_name }} name="class_name" type="text" id="class_name" class="form-control form-control-sm"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    ...
                                    <select name="major_id" id="major_id" class="form-control form-control-sm">
                                        @foreach($majors as $major)
                                            ...
                                            @if($study_class->major_id == $major->id)
                                                {{ 'selected' }}
                                                @endif
                                            >
                                                {{ $major->name }}
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <select name="academic_id" id="academic_id" class="form-control form-control-sm">
                                        @foreach($academics as $academic)
                                            ...
                                            @if($study_class->academic_id == $academic->id)
                                                {{ 'selected' }}
                                                @endif
                                            >
