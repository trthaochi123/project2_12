...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Classes list</h3>
                <div class="main-content">
                    <div class="btn-add">
                        <a href="{{ route('study_classes.create') }}">
                        ...
                        <table id="myDataTable" cellspacing="0" cellpadding="0" width="100%">
                            ...
                            @foreach($classes as $study_class)
                                <tr>
                                    ...
                                    <td>{{ $study_class->class_name }}</td>
                                    <td>{{ $study_class->majorName }}</td>
                                    <td>{{ $study_class->academicName}}</td>
                                    <td class="btn-edit">
                                        <div class="edit-block">
                                            <a href="{{ route('study_classes.edit',$study_class->id) }}">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                        </div>
                                    </td>
                                    <td class="btn-delete">
                                        <form method="post" action="{{ route('study_classes.destroy',$study_class->id) }}">
                                            @csrf
                                            @method('DELETE')
