...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Create A New Payment Type</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('payment_types.store') }}">
                        ...
                        <div class="inputs-list">
                            <div class="mt-3 mb-3">
                                ...
                                <input name="payment_type_name" type="text" id="payment_type_name" class="form-control form-control-sm"/>
                            </div>
                            <div class="mt-3 mb-3">
                                <label for="discount">Discount</label>
                                <input name="discount" type="text" id="discount" class="form-control form-control-sm"/>
                            </div>
                            <div class="mt-3 mb-3">
                                <label for="payment_times">Payment times</label>
                                <input name="payment_times" type="text" id="payment_times" class="form-control form-control-sm"/>
                            </div>
                            <div>
