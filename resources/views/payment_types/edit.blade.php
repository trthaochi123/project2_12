...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Edit Payment Type</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('payment_types.update',$id) }}">
                        ...
                        @foreach($payments as $payment)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    <label for="payment_type_name">Payment type name</label>
                                    <input value="{{ $payment->payment_type_name }}" name="payment_type_name" type="text" id="payment_type_name" class="form-control form-control-sm"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="discount">Discount</label>
                                    <input value="{{ $payment->discount }}" name="discount" type="text" id="discount" class="form-control form-control-sm"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="payment_times">Payment times</label>
                                    <input value="{{ $payment->payment_times }}" name="payment_times" type="text" id="payment_times" class="form-control form-control-sm"/>
                                </div>
                                @endforeach
                                <div>
