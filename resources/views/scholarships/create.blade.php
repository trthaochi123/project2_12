...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Create A New Scholarship</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('scholarships.store') }}">
                        ...
                        <div class="inputs-list">
                            <div class="mt-3 mb-3">
                                ...
                                <input name="scholarship_amount" type="text" id="scholarship_amount" class="form-control form-control-sm"/>
                            </div>
                            <div>
