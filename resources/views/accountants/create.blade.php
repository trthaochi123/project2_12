...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Create A New Accountant</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('accountants.store') }}" >
                        ...
                        <div class="inputs-list">
                            <div class="mt-3 mb-3">
                                ...
                                <input name="accountant_name" type="text" id="accountant_name" class="form-control form-control-sm"/>
                            </div>
                            <div class="mt-3 mb-3">
                                <label for="accountant_phone">Phone number</label>
                                <input name="accountant_phone" type="text" id="accountant_phone" class="form-control form-control-sm"/>
                            </div>
