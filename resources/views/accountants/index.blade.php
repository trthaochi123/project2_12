...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Accountants list</h3>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" id="myDataTable">
                            ...
                            @foreach($accountants as $accountant)
                                <tr>
                                    ...
                                    <td>{{ $accountant->province}} province, {{ $accountant->district}} district, {{ $accountant->street }} street</td>
                                    ...
                                    <td  class="btn-delete">
                                        <form method="post" action="{{ route('accountants.destroy', $accountant->id) }}">
                                            @csrf
                                            @method('DELETE')
