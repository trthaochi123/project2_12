...
<head>
    ...
    <title>Edit academic years</title>
</head>
<body>
    <div class="root">
        <div class="header">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Edit Major</h3>
                <div class="add-form">
                    <form method="post" action="{{route('majors.update', $id)}}">
                        ...
                        @foreach($majors as $major)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $major->name }}" name="name" type="text" id="major_name" class="form-control form-control-sm"/>
                                </div>
                                <div>
