                        ...
                        @foreach($admins as $admin)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $admin->admin_name }}" name="admin_name" type="text" id="admin_name" class="form-control form-control-sm"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="admin_phone">Phone number</label>
                                    <input value={{$admin->admin_phone}} name="admin_phone" type="text" id="admin_phone" class="form-control form-control-sm"/>
                                </div>
                                ...
                                <div class="mt-3 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                            ...
                                            <input value="{{ $admin->province }}" name="province" type="text" id="province" class="form-control form-control-sm"/>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                            <label for="district">District</label>
                                            <input value="{{ $admin-> district }}" name="district" type="text" id="district" class="form-control form-control-sm"/>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-3 col-3">
                                            <label for="street">Street</label>
                                            <input value="{{ $admin->street }}" name="street" type="text" id="street" class="form-control form-control-sm"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="email">Username</label>
                                    <input value="{{ $admin->email }}" name="email" type="text" id="email" class="form-control form-control-sm"/>
                                </div>
                                <div class="mt-3 mb-3">
                                    <label for="password">Password</label>
                                    <input value="{{ $admin->password }}" name="password" type="password" id="password" class="form-control form-control-sm"/>
                                </div>
                                <div>
