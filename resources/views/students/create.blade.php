                             ...
                             <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 ">
                                    <div class="mt-3 mb-3">
                                        ...
                                        <input name="student_name" type="text" id="student_name" class="form-control form-control-sm"/>
                                    </div>
                                    <div class="mt-3 mb-3">
                                        <label for="student_dob">Date of birth</label>
                                        <input name="student_dob" type="date" id="student_dob" class="form-control form-control-sm"/>
                                    </div>
                                    <div class="mt-3 mb-3">
                                        <label for="student_phone">Phone number</label>
                                        <input name="student_phone" type="text" id="student_phone" class="form-control form-control-sm"/>
                                    </div>
                                    <div class="mt-3 mb-3">
                                        <label>Address</label>
                                    </div>
                                    ...
                                    <div class="mt-3 mb-3">
                                        ...
                                        <div name="basic_fee" type="text" id="basic_fee" class="form-control form-control-sm">
                                    ...
                                    <div class="mt-3 mb-3">
                                        ...
                                        <input name="student_parent_phone" type="text" id="student_parent_phone" class="form-control form-control-sm"/>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 " >
                                    <div class="mt-3 mb-3">
                                    ...
                                    <div class="mt-3 mb-3">
                                        ...
                                        <select name="discount" type="text" id="discount" class="form-control form-control-sm">
                                            @foreach($payment_types as $payment_type)
                                                <option value="{{ $payment_type->id }}">
                                    ...
                                    <div class="mt-3 mb-3">
                                        ...
                                        <input name="total_fee" type="text" id="total_fee" class="form-control form-control-sm"/>
                                    </div>
                                    <div class="mt-3 mb-3">
                                        <label for="amount_each_time">Amount each time</label>
                                        <input name="amount_each_time" type="text" id="amount_each_time" class="form-control form-control-sm"/>
                                    </div>
                                    <div class="mt-3 mb-3">
                                        <label for="tuition_status">Tuition status</label>
                                        <input name="tuition_status" type="text" id="tuition_status" class="form-control form-control-sm"/>
                                    </div>
                                    <div class="mt-3 mb-3">
                                        <label for="debt">Debt</label>
                                        <input name="debt" type="text" id="debt" class="form-control form-control-sm"/>
                                    </div>
                                </div>
                            </div>
                            <div>
