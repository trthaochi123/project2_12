                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 ">
                                        <div class="mt-3 mb-3">
                                            ...
                                            <input value="{{ $student->student_name }}" name="student_name" type="text" id="student_name" class="form-control form-control-sm"/>
                                        </div>
                                        <div class="mt-3 mb-3">
                                            <label for="student_dob">Date of birth</label>
                                            <input value="{{ $student->student_dob }}" name="student_dob" type="date" id="student_dob" class="form-control form-control-sm"/>
                                        </div>
                                        <div class="mt-3 mb-3">
                                            <label for="student_phone">Phone number</label>
                                            <input value="{{ $student->student_phone }}" name="student_phone" type="text" id="student_phone" class="form-control form-control-sm"/>
                                        </div>
                                        <div class="mt-3 mb-3">
                                            <label>Address</label>
                                        </div>
                                        <div class="mt-3 mb-3 row">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4">
                                                ...
                                                <input value="{{ $student->province }}" name="province" type="text" id="province" class="form-control form-control-sm"/>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4">
                                                <label for="district">District</label>
                                                <input value="{{ $student->district }}" name="district" type="text" id="district" class="form-control form-control-sm"/>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4">
                                                <label for="street">Street</label>
                                                <input value="{{ $student->street }}" name="street" type="text" id="street" class="form-control form-control-sm"/>
                                            </div>
                                        </div>
                                        <div class="mt-3 mb-3">
                                            ...
                                            <select name="class_id" id="class_id" class="form-control form-control-sm" >
                                                @foreach($classes as $class_study)
                                                    ...
                                                    @if($student->class_id == $class_study->id)
                                                        {{ 'selected' }}
                                                        @endif
                                                    >
                                        ...
                                        <div class="mt-3 mb-3">
                                            ...
                                            <input value={{ $student->student_parent_phone }} name="student_parent_phone" type="text" id="student_parent_phone" class="form-control form-control-sm"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-6 " >
                                        ...
                                        <div class="mt-3 mb-3">
                                            ...
                                            <select name="scholarship_id" id="scholarship_id" class="form-control form-control-sm" >
                                                @foreach($scholarships as $scholarship)
                                                    <option value="{{ $scholarship->id }}"
                                                    @if($student->scholarship_id == $scholarship->id)
                                                        {{ 'selected' }}
                                                        @endif
                                                    >
                                        ...
                                        <div class="mt-3 mb-3">
                                            ...
                                            <input value={{ $student->total_fee }} name="total_fee" type="text" id="total_fee" class="form-control form-control-sm"/>
                                        </div>
                                        <div class="mt-3 mb-3">
                                            <label for="amount_each_time">Amount each time</label>
                                            <input value={{ $student->amount_each_time }} name="amount_each_time" type="text" id="amount_each_time" class="form-control form-control-sm"/>
                                        </div>
                                        <div class="mt-3 mb-3">
                                            <label for="payment_type_id">Payment type</label>
                                            <select name="payment_type_id" id="payment_type_id" class="form-control form-control-sm" >
                                                @foreach($payment_types as $payment_type)
                                                    <option value="{{ $payment_type->id }}"
                                                    @if($student->payment_type_id == $payment_type->id)
                                                        {{ 'selected' }}
                                                        @endif
                                                    >
                                        ...
                                        <div class="mt-3 mb-3">
                                            ...
                                            <input value="{{ $student->tuition_status }}" name="tuition_status" type="text" id="tuition_status" class="form-control form-control-sm"/>
                                        </div>
                                        <div class="mt-3 mb-3">
                                            <label for="debt">Debt</label>
                                            <input name="debt" value="{{ $student->debt }}" type="text" id="debt" class="form-control form-control-sm"/>
                                        </div>
                                    </div>
                                </div>
                                <div>
