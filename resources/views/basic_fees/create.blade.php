...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Create A New Basic Fee</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('basic_fees.store') }}">
                        ...
                        <div class="inputs-list">
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <input name="basic_fee_amount" type="text" id="basic_fee_amount" class="form-control form-control-sm"/>
                            </div>
                            <div>
