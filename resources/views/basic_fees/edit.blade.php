                        ...
                        @foreach($basic_fees as $basic_fee)
                            <div class="inputs-list">
                                <div class="mt-3 mb-3">
                                    ...
                                    <select name="major_id" id="major_id" class="form-control form-control-sm">
                                        @foreach($majors as $major)
                                            ...
                                            @if($basic_fee->major_id == $major->id)
                                                {{ 'selected' }}
                                                @endif
                                            >
                                                {{ $major->name }}
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <select name="academic_id" id="academic_id" class="form-control form-control-sm">
                                        @foreach($academics as $academic)
                                            ...
                                            @if($basic_fee->academic_id == $academic->id)
                                                {{ 'selected' }}
                                                @endif
                                ...
                                <div class="mt-3 mb-3">
                                    ...
                                    <input value="{{ $basic_fee->basic_fee_amount }}" name="basic_fee_amount" type="text" id="basic_fee_amount" class="form-control form-control-sm"/>
                                </div>
                                @endforeach
                                <div>
