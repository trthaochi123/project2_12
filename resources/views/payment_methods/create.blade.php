...
<body>
    <div class="root">
        ...
        <div class="main">
            ...
            <div class="content">
                <h3 class="table-name2">Create A New Payment Method</h3>
                <div class="add-form">
                    <form method="post" action="{{ route('payment_methods.store') }}">
                        ...
                        <div class="inputs-list">
                            <div class="mt-3 mb-3">
                                ...
                                <input name="name" type="text" id="payMethodName" class="form-control form-control-sm"/>
                            </div>
                            <div>
