...
Route::middleware('checkLoginAdmin')->prefix('/students')->group(function(){
    ...
    Route::get('/academics',[\App\Http\Controllers\StudentController::class,'academicsList'])->name('students.academics');
...
Route::middleware('checkLoginAccountant')->prefix('/receipts')->group(function(){
    ...
    Route::get('/debtByMons',[\App\Http\Controllers\StudentController::class,'debtByMonth'])->name('receipts.debtByMons');
    ...
    Route::get('/academics',[\App\Http\Controllers\ReceiptController::class,'academicsList'])->name('receipts.academics');
